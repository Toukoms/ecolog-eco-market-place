    ...
    <header className="sticky top-0 z-50 w-full bg-white/90 backdrop-blur-md shadow-sm border-b">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link to="/" className="font-medium hover:text-ecologis-green-dark transition-colors">Accueil</Link>
          <Link to="/produits" className="font-medium hover:text-ecologis-green-dark transition-colors">Produits</Link>
          <Link to="/about" className="font-medium hover:text-ecologis-green-dark transition-colors">À propos</Link>
          <Link to="/contact" className="font-medium hover:text-ecologis-green-dark transition-colors">Contact</Link>
        </nav>
